...
int main(void)
{
	...
	// Message queue 생성
	key_id = msgget((key_t)60084, IPC_CREAT | 0666); // send용 queue
	key_id2 = msgget((key_t)60085, IPC_CREAT | 0666); // recv용 queue
	key_id3 = msgget((key_t)60086, IPC_CREAT | 0666); // result send용 queue
